...
## Funcionamiento
 ...
 3. Finalmente, al encontrar un nodo hoja (sin vecinos) o el nodo solución (o la solución óptima) se detendrá la búsqueda, y se tiene almacenado el camino, costo y nodos expandidos.
